...
use RegularLabs\Scoped\Intervention\Image\AbstractDecoder;
...
class Decoder extends AbstractDecoder
{
    ...
    public function initFromPath($path)
    {
        ...
        try {
            ...
            throw new \RegularLabs\Scoped\Intervention\Image\Exception\NotReadableException("Unable to read image from path ({$path}).", 0, $e);
        }
        // build image
