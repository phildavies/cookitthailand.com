...
class AcyMailingHelper
{
    ...
    public static function load()
    {
		...
		// AcyMailing 10+ deprecated helpers/helper.php in favor of Core/init.php
		$version = Extension::getVersion('com_acym');
		if ($version && version_compare($version, '10.0.0', '>='))
		{
			$path = implode($ds, [JPATH_ADMINISTRATOR, 'components', 'com_acym', 'Core', 'init.php']);
		}
		else
		{
