                    ...
                    foreach ($type->links as $i => $link) :
                        ...
                        $html .= '<li>
								<div class="treeselect-item pull-left">
									...
									' . $link->text . ' <span class="small">' . JText::sprintf(
                            'JGLOBAL_LIST_ALIAS',
                            htmlentities($link->alias)
                        ) . '</span>
';
				...
				<div class="pull-left nav-hover treeselect-menu">
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li class=""><a class="checkall" href="javascript://"><span class="icon-checkbox"></span> ' . JText::_(
            'JSELECT'
        ) . '</a>
							</li>
							<li><a class="uncheckall" href="javascript://"><span class="icon-checkbox-unchecked"></span> ' . JText::_(
            'JCH_DESELECT'
        ) . '</a>
							</li>
							<div class="treeselect-menu-expand">
							<li class="divider"></li>
							<li><a class="expandall" href="javascript://"><span class="icon-plus"></span>' . JText::_(
            'JCH_EXPAND'
        ) . '</a></li>
							<li><a class="collapseall" href="javascript://"><span class="icon-minus"></span>' . JText::_(
            'JCH_COLLAPSE'
        ) . '</a></li>
							</div>
						</ul>
