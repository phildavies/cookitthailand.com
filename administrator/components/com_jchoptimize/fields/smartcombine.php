...
class JFormFieldSmartCombine extends JFormFieldRadio
{
    ...
    protected function getInput()
    {
        if (!JCH_PRO) {
            ...
            return '<div id="div-' . $this->fieldname . '">' . parent::getInput(
            ) . '<img id="img-' . $this->fieldname . '" src="' . JUri::root(
            ) . 'media/com_jchoptimize/core/images/exclude-loader.gif" style="display: none;"/> <button id="btn-' . $this->fieldname . '" type="button" class="btn btn-sm btn-secondary"  style="display: none;">Reprocess Smart Combine</button>
</div>';
        }
        //</div>
        //</div>
